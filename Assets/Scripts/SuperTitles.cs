...
public class SuperTitles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        linesOfDialogue.Add(new SuperTitleHelper(0f, 29f, "The rope dancers shut their trap, they did well to keep quiet. \n The Opéra-Comique blabbered on and on, \n and he should have just shut up."));
        linesOfDialogue.Add(new SuperTitleHelper(0f, 47f, "My fellow theatres, the other Polichinelles, made way for me. \n Thus, it is fair that I make the decisions as sovereign."));
        linesOfDialogue.Add(new SuperTitleHelper(1f, 6f, "Here comes the Opéra. Let's start with him."));
        linesOfDialogue.Add(new SuperTitleHelper(1f, 11f, "Hello, Polichinelle my friend. \n They say that your parody of Persée is quite funny."));
        linesOfDialogue.Add(new SuperTitleHelper(1f, 21f, "I just saw it. Are you roasting me too?"));
        linesOfDialogue.Add(new SuperTitleHelper(1f, 28f, "I've been doing it for a long time. \n You provide me with plenty of sticks to beat you with."));
        linesOfDialogue.Add(new SuperTitleHelper(1f, 36f, "What's that piece of paper you have? \n Is it a play for the new season?"));
        linesOfDialogue.Add(new SuperTitleHelper(1f, 47f, "These are the bills from Persée. \n The expenses from the tailors alone are bankrupting me."));
        ...
        linesOfDialogue.Add(new SuperTitleHelper(3f, 39f, "Ah, It's the Comédie-Française!\n We all know that she makes her dough with the public."));
        linesOfDialogue.Add(new SuperTitleHelper(4f, 01f, "I have come to relax after my noble labors."));
        linesOfDialogue.Add(new SuperTitleHelper(4f, 07f, "The Opéra is much more popular, \n it is open called the cousin of the Opéra-Comique. \n The Opéra is even paid to help handle the embarrassment."));
        ...
        linesOfDialogue.Add(new SuperTitleHelper(4f, 33f, "I had a good haul. \n Despite my arrogance, the finest poets bring me their work with respect. \n That's what's ruining you."));
        linesOfDialogue.Add(new SuperTitleHelper(4f, 46f, "Go take a seat near the Opéra, you two can go hand in hand."));
        linesOfDialogue.Add(new SuperTitleHelper(4f, 52f, "If I'm pleased, \n I will grant you my protection and you can count on my friendship."));
        linesOfDialogue.Add(new SuperTitleHelper(5f, 02f, "Seems like you learned your lesson from The School of Friends. \n We will see about that."));
